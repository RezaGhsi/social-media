  ...
  return (
    <>
      <aside className="sticky top-4 flex h-160 flex-[1.5] flex-col">
        ...
        <section className="my-4 overflow-hidden rounded-lg bg-white *:*:mr-2 *:flex *:px-6 *:py-4 *:transition-colors *:hover:bg-[#f1f1f1]">
          ...
          <a href="javascript:void(0)">
            <div className="relative">
              ...
              <div className="absolute -top-1 -right-1 flex min-w-3.5 items-center justify-center rounded-full bg-red-500 text-[10px] text-white">
                <span>2</span>
              </div>
            </div>
            <span>Messages</span>
        ...
        <a
          href="upload"
          className="flex w-full cursor-pointer justify-center rounded-full bg-indigo-700 py-2 text-white transition-colors hover:bg-indigo-500"
        >
          Create post
        </a>
      </aside>
